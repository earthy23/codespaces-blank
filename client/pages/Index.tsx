        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Your hub for Eaglercraft clients. Built by the community, for the
              community.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register">
                <Button
                  size="lg"
                  className="minecraft-button bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg"
                >
                  Get Started
                </Button>
              </Link>
              <Link to="/downloads">
                <Button
                  size="lg"
                  variant="outline"
                  className="minecraft-button px-8 py-6 text-lg"
                >
                  Browse Clients
                </Button>
              </Link>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We made this because we got tired of sketchy client sites and
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="minecraft-panel">
              <CardContent className="p-6 text-center">
                <div className="w-16 h-16 bg-primary/20 rounded-xl flex items-center justify-center mx-auto mb-4"></div>
                <h3 className="text-xl font-semibold mb-3">Quick Access</h3>
                <p className="text-muted-foreground">
                  Launch clients straight from your browser. No more hunting
                  around for working links.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="minecraft-panel">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Chat with friends without lag. Voice chat that doesn't cut out
                  every 5 seconds.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="minecraft-panel">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Clean interface, no ads, no crypto miners. Just works like it
                  should.
                </p>
              </CardContent>
            </Card>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-left">
                <p className="text-lg text-muted-foreground mb-6">
                  Started this project because finding decent Eaglercraft
                  clients was a pain. Too many broken sites, sketchy downloads,
                  and terrible UIs. So we built something better.
                </p>
              ...
              <div className="minecraft-panel p-8">
                <div className="w-full h-48 bg-primary/10 rounded-lg flex items-center justify-center"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 py-16 bg-primary/5">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to ditch the sketchy sites?
          </h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join the community that's tired of broken clients and wants
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Eaglercraft launcher that doesn't suck. Made by players, for
                players.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <Link to="/downloads" className="hover:text-primary">
                    Downloads
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/forums" className="hover:text-primary">
                    Forums
                  </Link>
                </li>
              </ul>
